...
class UserAuthorityVC: UIViewController {
    ...
    private func setTestCube() {
        ...
        testCube.centerXAnchor.constraint(equalTo: view.centerXAnchor).isActive = true
        testCube.bottomAnchor.constraint(equalTo: view.bottomAnchor, constant: 0).isActive = true
        testCube.heightAnchor.constraint(equalTo: view.heightAnchor, multiplier: 0.1).isActive = true
        testCube.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 10).isActive = true
        testCube.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -10).isActive = true
    }

    private func setTestCube1() {
        testCube.translatesAutoresizingMaskIntoConstraints = false
        testCube.centerXAnchor.constraint(equalTo: view.centerXAnchor).isActive = true
        testCube.bottomAnchor.constraint(equalTo: view.bottomAnchor, constant: -50).isActive = true
        testCube.heightAnchor.constraint(equalTo: view.heightAnchor, multiplier: 0.1).isActive = true
        testCube.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 10).isActive = true
        testCube.trailingAnchor.constraint(equalTo: view.trailingAnchor, constant: -10).isActive = true
    }
    ...
    private func setBaseViewConstriants() {
        ...
        baseView.bottomAnchor.constraint(equalTo: view.bottomAnchor, constant: -30).isActive = true
